...
function Valores() {
  return (
    <section id="valores" className="py-16 px-4 md:px-8 bg-[#FCECC9]">
      <div className="container mx-auto max-w-4xl text-center">
        <h2 className="text-4xl font-bold text-[#E4670D] mb-8">Valores 2025</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {/* Modalidades */}
          <div className="bg-white p-6 rounded-lg shadow-md border-2 border-[#E4670D] flex flex-col justify-center">
            <h3 className="text-xl font-semibold text-[#445E93] mb-4">Modalidades Oferecidas</h3>
            <ul className="space-y-2 text-[#260C1A] text-left">
          ...
          {/* Pacotes Regulares */}
          <div className="bg-white p-6 rounded-lg shadow-md border-2 border-[#E4670D] flex flex-col justify-center">
            <h3 className="text-xl font-semibold text-[#445E93] mb-4">Pacotes Regulares</h3>
            <table className="w-full text-left text-[#260C1A]">
              <thead>
                <tr>
          ...
          {/* Pacote VIP */}
          <div className="bg-white p-6 rounded-lg shadow-md border-2 border-[#E4670D] flex flex-col justify-center">
            <h3 className="text-xl font-semibold text-[#445E93] mb-4 flex items-center justify-center">Pacote VIP <span className="ml-2">⭐</span> <span className="ml-2 text-base font-normal">(aula individual)</span></h3>
            <table className="w-full text-left text-[#260C1A]">
              <thead>
                <tr>
                  <th className="pb-2">Aulas/Mês</th>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 text-center">
          <div className="bg-white border-2 border-[#E4670D] p-4 rounded-lg shadow flex flex-col justify-center">
            <p className="font-semibold text-[#445E93]">Aula Experimental</p>
            <p className="text-lg text-[#260C1A]">R$15</p>
          </div>
          <div className="bg-white border-2 border-[#E4670D] p-4 rounded-lg shadow flex flex-col justify-center">
            <p className="font-semibold text-[#445E93]">Matrícula</p>
            <p className="text-lg text-[#260C1A]">R$50</p>
          </div>
          <div className="bg-white border-2 border-[#E4670D] p-4 rounded-lg shadow flex flex-col justify-center">
            <p className="font-semibold text-[#445E93]">Aula VIP</p>
            <p className="text-lg text-[#260C1A]">R$90</p>
          </div>
        </div>
      </div>
    </section>
